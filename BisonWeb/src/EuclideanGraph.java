...
public class EuclideanGraph {
    ...
    *******************************************************************/
    ...
    /*******
     * 
     * Modified Constructor below
     * @return
     ********/
    
    public EuclideanGraph(ArrayList<Integer> GSID,ArrayList<Integer> GDID,ArrayList<Integer> NLSID,ArrayList<Integer> NLX,ArrayList<Integer> NLY) {
        V = NLSID.size();
        E = GSID.size();
